...
namespace TrackingWebApp.Controllers
{
    public class ExpensesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Cost,ProjectId")] Expense expense)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Cost,ProjectId")] Expense expense)
        {
            if (id != expense.Id)
            {
                return NotFound();
